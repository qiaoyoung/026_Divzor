...
@property (nonatomic, strong) UIColor *centerBody;
/* 最小高度，如果需要随文字改变高度的时候使用 */
//: @property (nonatomic, assign) CGFloat minHeight;
@property (nonatomic, assign) CGFloat bind;
//: @property (nonatomic, copy) textViewHeightDidChangedBlock textViewHeightDidChanged;
@property (nonatomic, copy) textViewHeightDidChangedBlock info;
/* 最大高度，如果需要随文字改变高度的时候使用 */
//: @property (nonatomic, assign) CGFloat maxHeight;
@property (nonatomic, assign) CGFloat activity;
@property (nonatomic, assign) CGFloat responseFloat;
/* 获取图片数组 */
//: - (NSArray *)getImages;
- (NSArray *)spare;
...
- (void)progress:(CGFloat)maxHeight forestFire:(textViewHeightDidChangedBlock)textViewHeightDidChanged;
