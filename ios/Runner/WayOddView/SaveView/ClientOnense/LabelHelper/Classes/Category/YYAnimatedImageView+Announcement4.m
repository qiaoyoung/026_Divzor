...
// __CLOSE_PRINT__
//
//  YYAnimatedImageView+Announcement4.m
// Warning
//
...
#import "YYAnimatedImageView+Announcement4.h"
//: #import <objc/runtime.h>
#import <objc/runtime.h>

//: @implementation YYAnimatedImageView (iOS14)
@implementation YYAnimatedImageView (Announcement4)

//: - (void)lz_displayLayer:(CALayer *)layer {
- (void)compartments:(CALayer *)layer {
...
+ (void)load {
    ...
    _dispatch_once(&onceToken, ^{
        ...
        method1 = class_getInstanceMethod([self class], @selector(compartments:));
