 ...
 *
 * 如果您在使用 LabelHelper 的过程中出现bug或有更好的建议,还请及时以下列方式联系我,我会及
 * 时修复bug,解决问题.
 *
...
+ (__kindof NSURLSessionTask *)load:(NSString *)URL
...
+ (__kindof NSURLSessionTask *)permit:(NSString *)URL
                         //: parameters:(id)parameters
...
+ (void)setExtended:(void(^)(Blank *sessionManager))sessionManager;
 ...
 */
//: + (__kindof NSURLSessionTask *)POST:(NSString *)URL
+ (__kindof NSURLSessionTask *)hide:(NSString *)URL
                         //: parameters:(id)parameters
...
+ (__kindof NSURLSessionTask *)peopleFailure:(NSString *)URL
                                       //: parameters:(id)parameters
                                       ground:(id)parameters
                                             //: name:(NSString *)name
                                             degree_strong:(NSString *)name
                                             //: data:(NSData *)data
                                             streetSmart:(NSData *)data
                                         //: fileName:(NSString *)fileName
                                         announcement:(NSString *)fileName
                                        //: imageType:(NSString *)imageType
                                        imageOpen:(NSString *)imageType
                                         //: progress:(YLHttpProgress)progress
                                         quantityeractionHttpProgress:(YLHttpProgress)progress
                                          //: success:(YLHttpRequestSuccess)success
                                          effect:(YLHttpRequestSuccess)success
                                          //: failure:(YLHttpRequestFailed)failure;
                                          familyElect:(YLHttpRequestFailed)failure;
/// 手机网络:YES, 反之:NO
//: + (BOOL)isWWANNetwork;
+ (BOOL)via;
...
+ (__kindof NSURLSessionTask *)hearing:(NSString *)URL
                                        //: parameters:(id)parameters
 ...
 */
//: + (__kindof NSURLSessionTask *)GET:(NSString *)URL
+ (__kindof NSURLSessionTask *)back:(NSString *)URL
                        //: parameters:(id)parameters
...
+ (__kindof NSURLSessionTask *)fileFailure:(NSString *)URL
                                      //: parameters:(id)parameters
