...
+ (NSString*)showTime:(NSTimeInterval) msglastTime showDetail:(BOOL)showDetail
{
    ...
    {
        result = showDetail?  [[NSString alloc] initWithFormat:@"%@%@ %zd:%02d".string_localized,LangKey(@"yesterday"),result,hour,(int)msgDateComponents.minute] : LangKey(@"yesterday");//@"昨天".string_localized;
    }
    else if(isSameMonth && (nowDateComponents.day == (msgDateComponents.day+2))) //前天
    {
        result = showDetail? [[NSString alloc] initWithFormat:@"%@%@ %zd:%02d".string_localized,LangKey(@"before_yesterday"),result,hour,(int)msgDateComponents.minute] : LangKey(@"before_yesterday");//@"前天".string_localized;
    }
...
+ (NSString *)getPeriodOfTime:(NSInteger)time withMinute:(NSInteger)minute
{
    ...
    {
        showPeriodOfTime = LangKey(@"wee_hours");//@"凌晨".string_localized;
    }
    else if (totalMin > 5 * 60 && totalMin < 12 * 60)
    {
        showPeriodOfTime = LangKey(@"day_am");//@"上午".string_localized;
    }
    else if (totalMin >= 12 * 60 && totalMin <= 18 * 60)
    {
        showPeriodOfTime =  LangKey(@"day_pm");//@"下午".string_localized;
    }
    else if ((totalMin > 18 * 60 && totalMin <= (23 * 60 + 59)) || totalMin == 0)
    {
        showPeriodOfTime = LangKey(@"day_night");//@"晚上".string_localized;
    }
...
+(NSString*)weekdayStr:(NSInteger)dayOfWeek
{
    ...
    daysOfWeekDict = @{@(1):LangKey(@"Sunday"),//@"星期日".string_localized,
                       @(2):LangKey(@"Monday"),//@"星期一".string_localized,
                       @(3):LangKey(@"Tuesday"),//@"星期二".string_localized,
                       @(4):LangKey(@"Wednesday"),//@"星期三".string_localized,
                       @(5):LangKey(@"Thursday"),//@"星期四".string_localized,
                       @(6):LangKey(@"Friday"),//@"星期五".string_localized,
                       @(7):LangKey(@"Saturday")};//@"星期六".string_localized,};
...
+ (NSString*)teamNotificationFormatedMessage:(NIMMessage *)message{
    ...
    if (object.notificationType == NIMNotificationTypeTeam)
    {
        ...
        switch (content.operationType) {
            case NIMTeamOperationTypeInvite:{
                NSString *str = [NSString stringWithFormat:@"%@%@%@".string_localized,source,LangKey(@"message_helper_invite"),targets.firstObject];
                if (targets.count>1) {
                    str = [str stringByAppendingFormat:@"%zd%@".string_localized,targets.count,LangKey(@"message_people")];
                }
                str = [str stringByAppendingFormat:@"%@%@".string_localized,LangKey(@"message_enter"),teamName];
                formatedMessage = str;
            }
                break;
            case NIMTeamOperationTypeDismiss:
                formatedMessage = [NSString stringWithFormat:@"%@%@%@".string_localized,source,LangKey(@"message_dismissed"),teamName];
                break;
            case NIMTeamOperationTypeKick:{
                ...
                str = [str stringByAppendingFormat:@"%@%@".string_localized,LangKey(@"message_move_out"),teamName];
                formatedMessage = str;
            }
                break;
            case NIMTeamOperationTypeUpdate:
            {
                ...
                if ([attachment isKindOfClass:[NIMUpdateTeamInfoAttachment class]]) {
                    ...
                    formatedMessage = [NSString stringWithFormat:@"%@%@%@%@".string_localized,source,update,teamName,LangKey(@"message_information")];
                    ...
                    if ([teamAttachment.values count] == 1) {
                        ...
                        switch (tag) {
                            case NIMTeamUpdateTagName:
                                formatedMessage = [NSString stringWithFormat:@"%@%@%@%@".string_localized,source,update,teamName,LangKey(@"message_name")];
                                break;
                            case NIMTeamUpdateTagIntro:
                                formatedMessage = [NSString stringWithFormat:@"%@%@%@%@".string_localized,source,update,teamName,LangKey(@"message_introduce")];
                                break;
                            case NIMTeamUpdateTagAnouncement:
                                formatedMessage = [NSString stringWithFormat:@"%@%@%@%@".string_localized,source,update,teamName,LangKey(@"message_proclamation")];
                                break;
                            case NIMTeamUpdateTagJoinMode:
                                formatedMessage = [NSString stringWithFormat:@"%@%@%@%@".string_localized,source,update,teamName,LangKey(@"message_verification_mode")];
                                break;
                            case NIMTeamUpdateTagAvatar:
                                formatedMessage = [NSString stringWithFormat:@"%@%@%@%@".string_localized,source,update,teamName,LangKey(@"message_head_portrait")];
                                break;
                            case NIMTeamUpdateTagInviteMode:
                                formatedMessage = [NSString stringWithFormat:@"%@%@".string_localized,source,LangKey(@"message_invite_permission")];
                                break;
                            case NIMTeamUpdateTagBeInviteMode:
                                formatedMessage = [NSString stringWithFormat:@"%@%@".string_localized,source,LangKey(@"message_permissions_updated")];
                                break;
                            case NIMTeamUpdateTagUpdateInfoMode:
                                formatedMessage = [NSString stringWithFormat:@"%@%@".string_localized,source,LangKey(@"message_modification_permissions")];
                                break;
                            case NIMTeamUpdateTagMuteMode:{
                                ...
                                formatedMessage = muted? [NSString stringWithFormat:@"%@%@".string_localized,source,LangKey(@"message_forbidden_speech")]: [NSString stringWithFormat:@"%@%@".string_localized,source,LangKey(@"message_been_lifted")];
                                break;
                            }
                            default:
                                break;
            ...
            case NIMTeamOperationTypeLeave:
                formatedMessage = [NSString stringWithFormat:@"%@%@%@".string_localized,source,LangKey(@"message_leave"),teamName];
                break;
            case NIMTeamOperationTypeApplyPass:{
                if ([source isEqualToString:targetText]) {
                    //说明是以不需要验证的方式进入
                    formatedMessage = [NSString stringWithFormat:@"%@%@%@".string_localized,source,LangKey(@"message_enter"),teamName];
                }else{
                    formatedMessage = [NSString stringWithFormat:@"%@%@%@%@".string_localized,source,LangKey(@"message_passed"),targetText,LangKey(@"message_apply_for")];
                }
            }
                break;
            case NIMTeamOperationTypeTransferOwner:
                formatedMessage = [NSString stringWithFormat:@"%@%@%@".string_localized,source,LangKey(@"message_transferred_group_master"),targetText];
                break;
            case NIMTeamOperationTypeAddManager:
                formatedMessage = [NSString stringWithFormat:@"%@%@".string_localized,targetText,LangKey(@"message_group_administrator")];
                break;
            case NIMTeamOperationTypeRemoveManager:
                formatedMessage = [NSString stringWithFormat:@"%@%@".string_localized,targetText,LangKey(@"message_group_revoked")];
                break;
            case NIMTeamOperationTypeAcceptInvitation:
                formatedMessage = [NSString stringWithFormat:@"%@%@%@%@".string_localized,source,LangKey(@"message_accept"),targetText,LangKey(@"message_invited_into")];
                break;
            case NIMTeamOperationTypeMute:{
                ...
                if ([attachment isKindOfClass:[NIMMuteTeamMemberAttachment class]])
                {
                    ...
                    formatedMessage = [NSString stringWithFormat:@"%@%@%@%@".string_localized,str,LangKey(@"message_remove_by"),source,muteStr];
                }
            }
                break;
            default:
    ...
    if (!formatedMessage.length) {
        formatedMessage = LangKey(@"message_unknown_system_message");//@"未知系统消息".string_localized;
    }
    ...
    if (object.notificationType == NIMNotificationTypeSuperTeam)
    {
        ...
        switch (content.operationType) {
            ...
            case NIMSuperTeamOperationTypeKick:{
                NSString *str = [NSString stringWithFormat:@"%@%@%@".string_localized,source,LangKey(@"message_remove_by"),targets.firstObject];
                if (targets.count>1) {
                    str = [str stringByAppendingFormat:@"%zd%@".string_localized,targets.count,LangKey(@"message_people")];
                }
                str = [str stringByAppendingFormat:@"%@%@".string_localized,LangKey(@"message_move_out"),teamName];
                    ...
                    if ([teamAttachment.values count] == 1) {
                        ...
                        switch (tag) {
                            ...
                            case NIMSuperTeamUpdateTagClientCustom:
                                formatedMessage = [NSString stringWithFormat:@"%@%@".string_localized,source,LangKey(@"message_custom_extension")];
                                break;
            ...
            case NIMSuperTeamOperationTypeTransferOwner:
                formatedMessage = [NSString stringWithFormat:@"%@%@%@".string_localized,source,LangKey(@"message_transferred_group_master"),targets.firstObject];
                break;
            case NIMSuperTeamOperationTypeAddManager:
                formatedMessage = [NSString stringWithFormat:@"%@%@".string_localized,targets.firstObject,LangKey(@"message_group_administrator")];
                break;
            case NIMSuperTeamOperationTypeRemoveManager:
                formatedMessage = [NSString stringWithFormat:@"%@%@".string_localized,targets.firstObject,LangKey(@"message_group_revoked")];
                break;
...
+ (NSString *)rtcCallRecordFormatedMessage:(NIMMessage *)message {
    ...
    switch (record.callStatus) {
        case NIMRtcCallStatusCanceled:
            return LangKey(@"app_avchat_cancel");//@"已取消".string_localized;
        case NIMRtcCallStatusTimeout:
            return LangKey(@"app_avchat_no_pick_up");//@"未接听".string_localized;
        case NIMRtcCallStatusRejected:
            return LangKey(@"app_avchat_has_reject");//@"已拒绝".string_localized;
        case NIMRtcCallStatusBusy:
            if ([message.from isEqualToString:NIMSDK.sharedSDK.loginManager.currentAccount]) {
                return LangKey(@"app_avchat_has_reject");//@"已拒绝".string_localized;
            }
            return LangKey(@"app_avchat_is_busy_opposite");//@"对方正忙".string_localized;
...
+ (NSString *)netcallNotificationFormatedMessage:(NIMMessage *)message{
    ...
    switch (content.eventType) {
        case NIMNetCallEventTypeMiss:{
            text = LangKey(@"app_avchat_no_pick_up");//@"未接听".string_localized;
            break;
        }
        ...
        case NIMNetCallEventTypeNoResponse:{
            text = LangKey(@"message_access_failure");//@"未接通，已取消".string_localized;
            break;
        }
        default:
            break;
...
+ (NSString *)chatroomNotificationFormatedMessage:(NIMMessage *)message{
    ...
    for (NIMChatroomNotificationMember *memebr in content.targets) {
        if ([memebr.userId isEqualToString:[[NIMSDK sharedSDK].loginManager currentAccount]]) {
           [targetNicks addObject:LangKey(@"message_helper_you")];// @"你".string_localized
        }else{
    ...
    switch (content.eventType) {
        ...
        {
            return [NSString stringWithFormat:@"%@%@%@".string_localized,LangKey(@"message_welcome"),targetText,LangKey(@"")];
        }
        ...
        case NIMChatroomEventTypeAddMute:
        {
            ...
            {
                return LangKey(@"message_temporarily_muted");//@"你已被禁言".string_localized;
            }
            else
            {
                return [NSString stringWithFormat:@"%@ %@".string_localized,targetText,LangKey(@"message_muted_administrator")];
            }
        }
        case NIMChatroomEventTypeRemoveMute:
        {
            return [NSString stringWithFormat:@"%@ %@".string_localized,targetText,LangKey(@"message_unmuted_administrator")];
        }
        case NIMChatroomEventTypeAddManager:
        {
            return [NSString stringWithFormat:@"%@ %@".string_localized,targetText,LangKey(@"message_appointed_admin")];
        }
        case NIMChatroomEventTypeRemoveManager:
        {
            return [NSString stringWithFormat:@"%@ %@".string_localized,targetText,LangKey(@"message_dismissed_admin")];
        }
        case NIMChatroomEventTypeRemoveCommon:
        {
            return [NSString stringWithFormat:@"%@ %@".string_localized,targetText,LangKey(@"message_dismissed_member_identity")];
        }
        case NIMChatroomEventTypeAddCommon:
        {
            return [NSString stringWithFormat:@"%@%@".string_localized,targetText,LangKey(@"message_added_member")];
        }
        case NIMChatroomEventTypeInfoUpdated:
        {
            return LangKey(@"message_announcement_updated");//@"直播间公告已更新".string_localized;
        }
        case NIMChatroomEventTypeKicked:
        {
            return [NSString stringWithFormat:@"%@%@".string_localized,targetText,LangKey(@"message_removed_room")];
        }
        case NIMChatroomEventTypeExit:
        {
            return [NSString stringWithFormat:@"%@%@".string_localized,targetText,LangKey(@"message_left_room")];
        }
        case NIMChatroomEventTypeClosed:
        {
            return LangKey(@"message_room_closed");//@"直播间已关闭".string_localized;
        }
        case NIMChatroomEventTypeAddMuteTemporarily:
        {
            if (content.targets.count == 1 && [[content.targets.firstObject userId] isEqualToString:[[NIMSDK sharedSDK].loginManager currentAccount]])
            {
                return LangKey(@"message_temporarily_muted");//@"你已被临时禁言".string_localized;
            }
            else
            {
                return [NSString stringWithFormat:@"%@%@".string_localized,targetText,LangKey(@"message_muted_administrator")];
        ...
        {
            return [NSString stringWithFormat:@"%@%@".string_localized,targetText,LangKey(@"message_dismiss_temporary")];
        }
        case NIMChatroomEventTypeMemberUpdateInfo:
        {
            return [NSString stringWithFormat:@"%@%@".string_localized,targetText,LangKey(@"message_updated_information")];
        }
        case NIMChatroomEventTypeRoomMuted:
        {
            return LangKey(@"message_administrator_speak");//@"全体禁言，管理员可发言".string_localized;
        }
        case NIMChatroomEventTypeRoomUnMuted:
        {
            return LangKey(@"message_dismiss_whole_mute");//@"解除全体禁言".string_localized;
        }
        case NIMChatroomEventTypeQueueChange:
        case NIMChatroomEventTypeQueueBatchChange:
            return [NSString stringWithFormat:@"%@%@".string_localized,opeText,LangKey(@"message_changed_room_queue")];
        default:
            break;
    }
    return @"";
...
+ (NSString *)teamNotificationSourceName:(NIMMessage *)message{
    ...
    if ([content.sourceID isEqualToString:currentAccount]) {
        source = LangKey(@"message_helper_you");//@"你".string_localized;
    }else{
...
+ (NSString *)teamNotificationTeamShowName:(NIMMessage *)message{
    ...
    NSString *teamName = team.type == NIMTeamTypeNormal ? LangKey(@"team_create_helper_discuss_name"):LangKey(@"contact_my_group_activity_title");//@"讨论组".string_localized : @"群".string_localized;
    return teamName;
}
...
+ (NSString *)superTeamNotificationTeamShowName:(NIMMessage *)message{
    NSString *teamName = LangKey(@"message_super_team");//@"超大群".string_localized;
    return teamName;
}
