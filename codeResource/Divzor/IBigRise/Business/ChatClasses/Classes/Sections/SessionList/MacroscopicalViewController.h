...
@interface MacroscopicalViewController : UIViewController<UITableViewDataSource,UITableViewDelegate,NIMLoginManagerDelegate,NIMConversationManagerDelegate>
/**
 *  会话列表tableView
 */
//: @property (nonatomic,strong) UITableView *tableView;
@property (nonatomic,strong) UITableView *citrusLimonTableView;
...
@property (nonatomic,assign) BOOL obscurantism;
@property (nonatomic,assign) BOOL farDoing;
...
- (void)recent:(NIMRecentSession *)recent
             //: atIndexPath:(NSIndexPath *)indexPath;
             houseCalculate:(NSIndexPath *)indexPath;
