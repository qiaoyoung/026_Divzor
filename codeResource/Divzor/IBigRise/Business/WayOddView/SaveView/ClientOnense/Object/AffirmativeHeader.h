...
@interface AffirmativeHeader : NSObject

//: @property (nonatomic, copy) NSString *appVersion;
@property (nonatomic, copy) NSString *emptySave;

//: @property (nonatomic, assign) NSInteger version;
@property (nonatomic, assign) NSInteger disabled;

@property (nonatomic, assign) NSInteger suspendTotal;

//: @property (nonatomic, assign) NSInteger totalInfoCount;
@property (nonatomic, assign) NSInteger source;

//: @property (nonatomic, copy) NSString *sdkVersion;
@property (nonatomic, copy) NSString *betwixt;
//: @property (nonatomic, assign) NIMLoginClientType clientType;
@property (nonatomic, assign) NIMLoginClientType need;

//: - (nullable NSData *)toRawContent;
- (nullable NSData *)digitizer;

//: + (nullable instancetype)initWithRawContent:(NSData *)data;
+ (nullable instancetype)initWithAtSelected:(NSData *)data;
