...
@property (nonatomic) CGPoint closely;

@property (nonatomic) CGFloat crossGray;
/**
...
@property (nonatomic) CGFloat always;

@property (nonatomic) CGFloat harborAdmin;
...
@property (nonatomic) CGFloat moon;
...
@property (nonatomic) CGFloat flag;
//: @property (nonatomic) CGFloat device_left;
@property (nonatomic) CGFloat linkTransaction;
...
@property (nonatomic) CGFloat modify;
...
@property (nonatomic) CGFloat placement;
...
@property (nonatomic) CGFloat disturbingPad;
/**
 * Shortcut for frame.size
 */
//: @property (nonatomic) CGSize device_size;
@property (nonatomic) CGSize implicitIn;
...
@property (nonatomic) CGFloat opinionRight;
