...
@implementation NSDictionary (Warning)

//: - (unsigned long long)nimkit_jsonUnsignedLongLong:(NSString *)key
- (unsigned long long)bedLong:(NSString *)key
{
...
- (NSArray *)panoply: (NSString *)key
{
    //: NSArray *array = [self nimkit_jsonArray:key];
    NSArray *array = [self calculate:key];
    //: BOOL invalid = NO;
    BOOL invalid = NO;
...
- (NSInteger)container: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]] ||
...
- (NSArray *)calculate: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
...
- (NSDictionary *)contactTo: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
