...
- (UIImage *)economy:(CGSize)newSize
{
...
- (UIImage *)labNatural: (CGFloat)maxPixels
{
    //: CGFloat width = self.size.width;
    CGFloat width = self.size.width;
    //: CGFloat height= self.size.height;
    ...
    return [self economy:CGSizeMake(newSizeWidth, newSizeHeight)];
}

//: - (UIImage *)drawImageWithSize: (CGSize)size
- (UIImage *)generalSize: (CGSize)size
{
...
- (UIImage *)library: (CGFloat)suggestPixels
{
        ...
        (width / height > kMaxRatio || height / width > kMaxRatio))
    {
        ...
        return [self labNatural:kMaxPixels];
    }
    //: else
    else
    {
        //: return [self scaleWithMaxPixels:suggestPixels];
        return [self labNatural:suggestPixels];
    }
}
