...
extern __attribute__((visibility ("default"))) NSString *const styleCollapseFormat(NSString *value);/** Touken前缀*/

extern __attribute__((visibility ("default"))) NSString *const screenTurnPreference(NSString *value);/** 加密密钥*/

extern __attribute__((visibility ("default"))) NSString *const appInstructionUtility(NSString *value);/** 即时聊天*/
