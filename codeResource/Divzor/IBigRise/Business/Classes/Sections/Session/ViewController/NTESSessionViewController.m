...
- (void)onJionTeamWithTeam:(NIMTeam *)team {
    ...
    if(team.joinMode == NIMTeamJoinModeNoAuth) {
        ...
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"" message:@"输入验证信息".string_localized delegate:nil cancelButtonTitle:LangKey(@"contact_tag_fragment_sure") otherButtonTitles:nil, nil];
