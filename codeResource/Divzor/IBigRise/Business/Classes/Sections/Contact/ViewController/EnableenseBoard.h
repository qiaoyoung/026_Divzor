...
@interface EnableenseBoard : NSObject
...
- (void)entranceInResistance:(void (^)(BOOL succeed, NSArray <PossibleQuest *> *contacts, NSArray <NSString *> *keys))completcion;
...
- (void)complection:(void (^)(BOOL succeed, NSArray <ErrGenderYard *> *contacts))completcion;
